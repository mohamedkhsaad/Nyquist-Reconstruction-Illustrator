...
from FinalGUI2 import Ui_MainWindow
import numpy as np
import scipy
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.actionOpen_File.triggered.connect(self.load)
        ...
        self.ui.A_lineEdit.returnPressed.connect(lambda: self.signal_preview)
        self.ui.F_lineEdit.returnPressed.connect(lambda: self.signal_preview)
        self.ui.Theta_lineEdit.returnPressed.connect(lambda: self.signal_preview)
    ...
    def signal_preview(self):
        ...
        Magnitude = float(self.ui.A_lineEdit.text())
        Frequency = float(self.ui.F_lineEdit.text()) 
        PhaseShift = float(self.ui.Theta_lineEdit.text())
